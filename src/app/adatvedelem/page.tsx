        ...
        <section className="relative px-6 md:px-12 pb-[100px] md:pb-[160px] z-10">
          <div className="mx-auto max-w-[1440px]">
            <div className="max-w-[720px] border-t border-border pt-10 md:pt-12">
              ...
              <p className="font-ui text-[16px] font-light text-secondary leading-[1.8] mb-6">
              ...
              <p className="font-ui text-[16px] font-light text-secondary leading-[1.8] mb-6 italic">
              ...
              <h2 className="font-syne text-[22px] font-bold text-primary mt-16 mb-5 uppercase tracking-wide">7. Adatbiztonság</h2>
              <p className="font-ui text-[16px] font-light text-secondary leading-[1.8] mb-4">
              ...
              <h2 className="font-syne text-[22px] font-bold text-primary mt-16 mb-5 uppercase tracking-wide">8. A tájékoztató módosítása</h2>
              <p className="font-ui text-[16px] font-light text-secondary leading-[1.8] mb-4">
