        ...
        <section className="relative px-6 md:px-12 pb-[100px] md:pb-[160px] z-10">
          <div className="mx-auto max-w-[1440px]">
            <div className="max-w-[720px] border-t border-border pt-10 md:pt-12">
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">1. Az ÁSZF hatálya és tárgya</h2>
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">2. A Szolgáltató adatai</h2>
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">3. A szolgáltatások köre</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">4. A szerződés létrejötte</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">5. Árak és fizetési feltételek</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">6. Teljesítési határidők</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">7. Megrendelő kötelezettségei</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">8. Szellemi tulajdon</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">9. Titoktartás</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">10. Felelősségkorlátozás</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[18px] md:text-[22px] font-bold text-foreground mt-12 md:mt-16 mb-5 uppercase tracking-wide">11. Elállás és felmondás</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[22px] font-bold text-foreground mt-16 mb-5 uppercase tracking-wide">12. Vitarendezés</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
              ...
              <h2 className="font-bold text-[22px] font-bold text-foreground mt-16 mb-5 uppercase tracking-wide">13. Az ÁSZF módosítása</h2>
              <p className=" text-[16px] font-light text-muted-foreground leading-[1.8] mb-4">
